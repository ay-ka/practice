...
<ul>
  ...
  <li>
    <b>NEAT - QMIX:</b> This project is about Implementing <b>QMIX</b> from scratch and combining with NEAT taken from <a href="https://neat-                                                                               python.readthedocs.io/en/latest/">this repo</a> and evaluate on RWARE benchmark
  </li>
    <li>
